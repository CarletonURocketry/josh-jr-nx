...
/* SPI123 clock source - PLL2P (150 MHz, within 200 MHz limit) */

#define STM32_RCC_D2CCIP1R_SPI123SRC RCC_D2CCIP1R_SPI123SEL_PLL2

/* SPI45 clock source - PLL2Q (30 MHz, within 100 MHz limit) */
...
/* SPI1 (LSM6DSO32 IMU): SCK=PA5, MISO=PA6, MOSI=PA7 */
...
/* SPI3 (LIS2MDL magnetometer, 3-wire): SCK=PB3, MOSI=PB2, MISO=PB4 (NC) */

#define GPIO_SPI3_SCK   (GPIO_SPI3_SCK_2  | GPIO_SPEED_50MHz)  /* PB3 */
#define GPIO_SPI3_MOSI  (GPIO_SPI3_MOSI_4 | GPIO_SPEED_50MHz)  /* PB2 */
#define GPIO_SPI3_MISO  (GPIO_SPI3_MISO_1 | GPIO_SPEED_50MHz)  /* PB4, not connected */

/* SPI2: SCK=PB13, MISO=PB14, MOSI=PB15 */

#define GPIO_SPI2_SCK   (GPIO_SPI2_SCK_4  | GPIO_SPEED_50MHz)  /* PB13 */
#define GPIO_SPI2_MISO  (GPIO_SPI2_MISO_1 | GPIO_SPEED_50MHz)  /* PB14 */
#define GPIO_SPI2_MOSI  (GPIO_SPI2_MOSI_1 | GPIO_SPEED_50MHz)  /* PB15 */

/* SPI4: SCK=PE12, MISO=PE13, MOSI=PE14 */
